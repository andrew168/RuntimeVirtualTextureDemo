...
void UCH_Blood::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UCH_Blood::Initialize(USkeletalMeshComponent* SkeletalMesh, USceneCaptureComponent2D* SceneCapture)
{
...
//ok
FTransform UCH_Blood::GetRefPoseBoneTransform(USkeletalMeshComponent* SkeletonMeshComponent, FName BoneName)
{
...
//ok
FVector UCH_Blood::TransformLocationByRefBoneTransform(FName BoneName, FVector WorldLocation)
{
...
//ok
FVector UCH_Blood::TransformDirectionByRefBoneTransform(FName BoneName, FVector WorldLocation)
{
	USkeletalMeshComponent* SKM = GetMesh();
...
//ok
USkeletalMeshComponent* UCH_Blood::GetMesh()
{
...
//ok
void UCH_Blood::CalculateRefTransforms()
{
...
//ok
void UCH_Blood::InitializeMaterials()
{
	if (GetMesh())
	{
...
//ok
void UCH_Blood::TakeHit(FName BoneName, FVector WorldSpaceLocation)
{
